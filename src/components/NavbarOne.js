              ...
              <div className='col-lg-10 col-md-9 text-md-start text-center'>
                <ul className='topbar-left'>
                  <li>
                    ...
                    Jl. Tulusari, Kecamatan Plupuh, Kabupaten Sragen, Jawa Tengah
                  </li>
                  {/* <li>
                    <FaRegClock />
          ...
          <div className='container nav-container'>
            <div className='responsive-mobile-menu'>
              <button
                ...
                data-target='#fajargrafika_main_menu'
                aria-expanded='false'
            ...
            <div className='logo'>
              <Link to='/'>
                <img src='assets/img/logo-2.png' alt='Fajar Grafika' />
              </Link>
            </div>
            ...
            <div className='nav-right-part nav-right-part-desktop'>
              ...
              }} className='btn btn-base b-animate-4' to='/contact'>
