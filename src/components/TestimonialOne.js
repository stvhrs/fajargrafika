            ...
            <Slider {...settings}>
              <div className='item'>
                <div className='single-testimonial-wrap'>
                  ...
                  <div className='client-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/testimonial/1.png' alt='Fajar Grafika' />
                    </div>
              ...
              <div className='item'>
                <div className='single-testimonial-wrap'>
                  ...
                  <div className='client-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/testimonial/2.png' alt='Fajar Grafika' />
                    </div>
                    <div className='details'>
                      <h5>MONISH POUL</h5>
                      <p>Co-Founder</p>
              ...
              <div className='item'>
                <div className='single-testimonial-wrap'>
                  ...
                  <div className='client-wrap'>
                    <div className='thumb'>
                      <img src='assets/img/testimonial/3.png' alt='Fajar Grafika' />
                    </div>
                    <div className='details'>
                      <h5>MICHEL CLACRK</h5>
                      <p>Co-Founder</p>
