        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <div className="section-title text-center"  style={{ paddingBottom :"25px", paddingTop :"25px", background: "url(assets/img/service/bg.png)" }}>
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-service-wrap">
                <div className="thumb">
                  <img src="assets/img/service/1.png" alt="Fajar Grafika" />
                  <div className="icon">
                    <img
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-service-wrap">
                <div className="thumb">
                  <img src="assets/img/service/2.png" alt="Fajar Grafika" />
                  <div className="icon">
                    <img
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-service-wrap">
                <div className="thumb">
                  <img src="assets/img/service/3.png" alt="Fajar Grafika" />
                  <div className="icon">
                    <img
            ...
            <div className="col-lg-3 col-md-6">
              <div className="single-service-wrap">
                <div className="thumb">
                  <img src="assets/img/service/4.png" alt="Fajar Grafika" />
                  <div className="icon">
                    <img
                ...
                <div className="details">
                  ...
                  <p>
                    Efficiently manage logistic distribution with safe road
                    transport solutions.
                  </p>
                  <div className="btn-wrap">
                    <Link className="read-more-text" to="/service-details">
