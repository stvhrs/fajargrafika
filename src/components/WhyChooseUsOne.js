          ...
          <div className='row justify-content-center'>
            <div className='col-xl-7 col-lg-6 order-lg-2'>
              <div className='video-thumb-wrap'>
                <img src='assets/img/wcu/video.png' alt='Fajar Grafika' />
                <span
            ...
            <div className='col-xl-5 col-lg-6 order-lg-1'>
              ...
              <div className='single-wcu-wrap'>
                <div className='icon'>
                  <img src='assets/img/wcu/icon-1.png' alt='Fajar Grafika' />
                </div>
              ...
              <div className='single-wcu-wrap'>
                <div className='icon'>
                  <img src='assets/img/wcu/icon-2.png' alt='Fajar Grafika' />
                </div>
                <div className='details'>
              ...
              <div className='single-wcu-wrap'>
                <div className='icon'>
                  <img src='assets/img/wcu/icon-3.png' alt='Fajar Grafika' />
                </div>
                <div className='details'>
